...
function UnsharedAlert() {
  ...
  <p>
    ...
    <br />
    If you wish to keep access to this slice for <strong>yourself</strong>, you
    can <strong>download it</strong> or <strong>save it in this browser</strong>
    .
    <br />
    If unsharing this slice was a <strong>mistake</strong>, you can
